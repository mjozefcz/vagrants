...
ovn-nbctl lr-add router-segment-1
ovn-nbctl lrp-add router-segment-1 router-segment-1-net1 40:44:00:00:00:04 192.168.0.1/24
...
ovn-nbctl lrp-add router-segment-1 router-segment-1-net2 40:44:00:00:00:05 192.168.1.1/24
...
ovn-nbctl lrp-add router-segment-1 router-segment-1-public 40:44:00:00:00:06 172.24.4.1/24
...
# Router 2 
ovn-nbctl lr-add router-segment-2
ovn-nbctl lrp-add router-segment-2 router-segment-2-net1 40:45:00:00:00:04 192.168.0.2/24
ovn-nbctl lsp-add network1 net1-router-segment-2
ovn-nbctl lsp-set-type net1-router-segment-2 router
ovn-nbctl lsp-set-addresses net1-router-segment-2 router
ovn-nbctl lsp-set-options net1-router-segment-2 router-port=router-segment-2-net1

ovn-nbctl lrp-add router-segment-2 router-segment-2-net2 40:45:00:00:00:05 192.168.1.2/24
ovn-nbctl lsp-add network2 net2-router-segment-2
ovn-nbctl lsp-set-type net2-router-segment-2 router
ovn-nbctl lsp-set-addresses net2-router-segment-2 router
ovn-nbctl lsp-set-options net2-router-segment-2 router-port=router-segment-2-net2

ovn-nbctl lrp-add router-segment-2 router-segment-2-public 40:45:00:00:00:30 172.24.6.1/24
...
ovn-nbctl lr-nat-add router-segment-1 snat 172.24.4.1 192.168.0.0/24
ovn-nbctl lr-nat-add router-segment-1 snat 172.24.4.1 192.168.1.0/24
ovn-nbctl lr-nat-add router-segment-1 dnat_and_snat 172.24.4.100 192.168.0.11 vm1 40:44:00:00:00:07


ovn-nbctl lr-nat-add router-segment-2 snat 172.24.6.1 192.168.0.0/24
ovn-nbctl lr-nat-add router-segment-2 snat 172.24.6.1 192.168.1.0/24
ovn-nbctl lr-nat-add router-segment-2 dnat_and_snat 172.24.6.101 192.168.0.12 vm2 40:44:00:00:00:08
